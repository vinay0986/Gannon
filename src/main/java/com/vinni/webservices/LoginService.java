...
public class LoginService {
    ...
    public Response save(LoginServiceRequest input) {
        try {
            ...
            Users user = (Users) em.createQuery("from Users where email=:em and passWord=:pwd").setParameter("em", input.getUserName()).setParameter("pwd", input.getPassword()).getSingleResult();
